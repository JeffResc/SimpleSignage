/*
  ...
  LOG_DEBUG: 0 to disable, 1 to enable
  SENTRY_URL: Optional Sentry URL for bug tracking
*/
...
if (process.env.SENTRY_URL !== 'undefined' && process.env.SENTRY_URL) {
...
const LOG_DEBUG = process.env.LOG_DEBUG || 0;
